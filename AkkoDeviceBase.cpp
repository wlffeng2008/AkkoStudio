...
static QList<AkkoDeviceInfo> s_AkkoDeviceTable = {
    ...
    {     7, 0x38EE, 0x0010, 1, 1, 0, "灵动V9 Max"},
    {     7, 0x38EE, 0x0011, 1, 1, 1, "灵动V9 Max"},
    ...
    {    17, 0x38EE, 0x000D, 1, 1, 0, "虫巢"},
    {    17, 0x38EE, 0x000F, 1, 1, 1, "虫巢"},
    ...
    {    28, 0x38EE, 0x0023, 2, 1, 0, "空影TAN8 Ultra"},
    {    28, 0x38EE, 0x0024, 2, 1, 1, "空影TAN8 Ultra"},
