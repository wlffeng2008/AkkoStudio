...
ModuleGenKeymapping::ModuleGenKeymapping(QWidget *parent):QWidget(parent)
{
    ...
    m_fnList.push_back(new keyItem({0x08, 0x00, 0x04, 0x00},tr("Profile-Exchange"))) ;
    ...
    m_fnList.push_back(new keyItem({0x08, 0x00, 0x04, 0x04},tr("Profile-Exchange5"))) ;
    ...
    m_muList.push_back(new keyItem({0x01, 0x00, 0xf0, 0x00},tr("Left")));
    m_muList.push_back(new keyItem({0x01, 0x00, 0xf1, 0x00},tr("Right")));
    m_muList.push_back(new keyItem({0x01, 0x00, 0xf2, 0x00},tr("Middle")));
    m_muList.push_back(new keyItem({0x01, 0x00, 0xf3, 0x00},tr("Back")));
    m_muList.push_back(new keyItem({0x01, 0x00, 0xf4, 0x00},tr("Forward")));
    m_muList.push_back(new keyItem({0x01, 0x00, 0xf5, 0x00},tr("Wheel-Left")));
    m_muList.push_back(new keyItem({0x01, 0x00, 0xf6, 0x00},tr("Wheel-Right")));
    m_muList.push_back(new keyItem({0x01, 0x00, 0xf7, 0x00},tr("Wheel-Forward")));
    m_muList.push_back(new keyItem({0x01, 0x00, 0xf8, 0x00},tr("Wheel-Back")));
    m_muList.push_back(new keyItem({0x01, 0x00, 0xf5, 0x01},tr("Scroll-Up")));
    m_muList.push_back(new keyItem({0x01, 0x00, 0xf5, 0xff},tr("Scroll-Down")));
